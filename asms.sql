...
-- ----------------------------
INSERT INTO `allgr_infos` VALUES ('gr_1', 'GR1', '我测试一下', '具备较完整的软件工程知识结构，能够将数学、自然科学、专业知识用于解决复杂软件系统问题', '0.00', '0.00', '1.00');
INSERT INTO `allgr_infos` VALUES ('gr_10', 'GR10', '', '能够就复杂软件工程问题与业界同行及社会公众进行有效沟通和交流，包括撰写报告和设计文稿、陈述发言、清晰表达或回应指令。并具备一定的国际视野，能够在跨文化背景下进行沟通和交流', '0.00', '0.00', '1.00');
INSERT INTO `allgr_infos` VALUES ('gr_11', 'GR11', '', '具有实际的软件工程项目工作经验及组织管理能力，理解并掌握工程管理原理与经济决策方法，并能跨行业应用', '0.00', '0.00', '1.00');
INSERT INTO `allgr_infos` VALUES ('gr_12', 'GR12', '', '具有自主学习和终身学习的意识，有不断学习和适应发展的能力', '0.00', '0.00', '1.00');
INSERT INTO `allgr_infos` VALUES ('gr_2', 'GR2', '', '能够应用数学、自然科学和工程科学的基本原理，通过文献研究和系统建模，分析复杂软件系统问题，以获得有效结论', '0.00', '0.00', '1.00');
INSERT INTO `allgr_infos` VALUES ('gr_3', 'GR3', '', '能够针对复杂软件工程问题，提出满足需求的总体设计和详细设计方案，并能够在设计环节中体现创新意识，考虑社会、健康、安全、法律、文化以及环境等因素', '0.00', '0.00', '1.00');
INSERT INTO `allgr_infos` VALUES ('gr_4', 'GR4', '', '能够基于算法原理并采用科学方法对复杂软件工程问题进行研究，设计实验方案，分析与解释数据，并通过信息综合得到合理有效的结论', '0.00', '0.00', '1.00');
INSERT INTO `allgr_infos` VALUES ('gr_5', 'GR5', '', '能够针对复杂软件系统，选择与使用合适的开发环境、工具与技术标准，进行模拟和测试，并对输出结果进行分析，得出相应的评估结论', '0.00', '0.00', '1.00');
INSERT INTO `allgr_infos` VALUES ('gr_6', 'GR6', '', '了解一个以上的软件工程应用领域相关技术和背景，能够基于软件工程相关背景知识进行合理分析，评价复杂软件工程对社会、健康、安全、法律以及文化的影响，并理解应承担的责任', '0.00', '0.00', '1.00');
INSERT INTO `allgr_infos` VALUES ('gr_7', 'GR7', '', '能够理解和评价针对软件工程及其相关领域的复杂工程问题对环境、社会可持续发展的影响', '0.00', '0.00', '1.00');
INSERT INTO `allgr_infos` VALUES ('gr_8', 'GR8', '', '具有人文社会科学素养、社会责任感，能够在工程实践中理解并遵守软件行业职业道德和规范，履行责任', '0.00', '0.00', '1.00');
INSERT INTO `allgr_infos` VALUES ('gr_9', 'GR9', '', '参与团队工程项目训练，能够在多学科背景下的团队中承担个体、团队成员以及负责人的角色', '0.00', '0.00', '1.00');
...
INSERT INTO `ccp_infos` VALUES ('45', '2014-2015_1_D1000735_ccp_3_2', '2014-2015_1_D1000735', '0', '平时作业2', '', '25', '20', '0', '2', '', '');
...
INSERT INTO `ccp_infos` VALUES ('49', '2014-2015_1_D1000735_ccp_4_1', '2014-2015_1_D1000735', '0', '实验1', '', '25', '20', '0', '2', '', '');
...
INSERT INTO `course_infos` VALUES ('2015-2016_1_ZX123', '网页制作', 'PHP', '50', '6', '学科基础课', '软件工程', 'ASMS', '操作系统', '超文本预读语言', 'PHP', '0.00', '战旭', '上机', '', '2016-09-28', '战旭');
...
INSERT INTO `gr_infos` VALUES ('gr_10_4', 'GR10.4', '', '了解软件工程领域国际发展前沿状况，能够就本专业热点问题表达自己的想法', '0.00', '0.00', '0.00', '1.00', '1.00');
INSERT INTO `gr_infos` VALUES ('gr_11_1', 'GR11.1', '', '具有校外工程实习的经历，并实际参与软件工程项目工作', '0.00', '0.00', '0.00', '1.00', '1.00');
INSERT INTO `gr_infos` VALUES ('gr_11_2', 'GR11.2', '', '熟悉软件工程项目过程，理解工程管理原理与经济决策方法', '0.00', '0.00', '0.00', '1.00', '1.00');
INSERT INTO `gr_infos` VALUES ('gr_11_3', 'GR11.3', '', ' 能够在不同领域综合应用工程管理原理和经济决策方法', '0.00', '0.00', '0.00', '1.00', '1.00');
INSERT INTO `gr_infos` VALUES ('gr_12_1', 'GR12.1', '', '能够认识不断学习的重要性和必要性，具有自主学习和终身学习的意识', '0.00', '0.00', '0.00', '1.00', '1.00');
INSERT INTO `gr_infos` VALUES ('gr_12_2', 'GR12.2', '', '掌握自主学习的方法，了解拓展知识和能力的途径', '0.00', '0.00', '0.00', '1.00', '1.00');
INSERT INTO `gr_infos` VALUES ('gr_12_3', 'GR12.3', '', '能够针对个人或职业发展的需求，采用合适的方法，自主学习，适应发展', '0.00', '0.00', '0.00', '1.00', '1.00');
INSERT INTO `gr_infos` VALUES ('gr_12_4', 'GR12.4', '', '掌握体育锻炼与运动的基本方法，为不断学习提供保障', '0.00', '0.00', '0.00', '1.00', '1.00');
INSERT INTO `gr_infos` VALUES ('gr_2_1', 'GR2.1', '', '能识别和判断复杂软件工程问题的关键环节和参数', '0.00', '0.00', '0.00', '1.00', '1.00');
INSERT INTO `gr_infos` VALUES ('gr_2_2', 'GR2.2', '', '能认识到解决问题有多种方案可选择', '0.00', '0.00', '0.00', '1.00', '1.00');
INSERT INTO `gr_infos` VALUES ('gr_2_3', 'GR2.3', '', '能分析文献寻求可替代的解决方案', '0.00', '0.00', '0.00', '1.00', '1.00');
INSERT INTO `gr_infos` VALUES ('gr_2_4', 'GR2.4', '', '能正确表达一个工程问题的解决方案，并证实方案的合理性', '0.00', '0.00', '0.00', '1.00', '1.00');
INSERT INTO `gr_infos` VALUES ('gr_3_1', 'GR3.1', '', '能够根据用户需求确定设计目标', '0.00', '0.00', '0.00', '1.00', '1.00');
INSERT INTO `gr_infos` VALUES ('gr_3_2', 'GR3.2', '', '能够在安全、环境、法律等约束条件下，通过技术经济评价对设计方案的可行性进行研究', '0.00', '0.00', '0.00', '1.00', '1.00');
INSERT INTO `gr_infos` VALUES ('gr_3_3', 'GR3.3', '', '能够针对复杂软件工程问题，设计满足特定需求的总体设计和详细设计', '0.00', '0.00', '0.00', '1.00', '1.00');
INSERT INTO `gr_infos` VALUES ('gr_3_4', 'GR3.4', '', '能够集成单元过程进行软件系统流程设计，对流程设计方案进行优选，体现创新意识', '0.00', '0.00', '0.00', '1.00', '1.00');
INSERT INTO `gr_infos` VALUES ('gr_4_1', 'GR4.1', '', '能够采用科学的方法对软件系统中的关键环节，设计相应的实验方案，搭建实验环境，开展实验', '0.00', '0.00', '0.00', '1.00', '1.00');
INSERT INTO `gr_infos` VALUES ('gr_4_2', 'GR4.2', '', '能够对实现结果进行分析和解释，并通过信息综合得到合理有效的结论', '0.00', '0.00', '0.00', '1.00', '1.00');
INSERT INTO `gr_infos` VALUES ('gr_5_1', 'GR5.1', '', '掌握获取技术、资源、现代工程工具和信息技术工具的能力', '0.00', '0.00', '0.00', '1.00', '1.00');
INSERT INTO `gr_infos` VALUES ('gr_5_2', 'GR5.2', '', '能够根据软件系统的应用场景，选择合适的开发环境、工具与技术标准进行软件系统的开发', '0.00', '0.00', '0.00', '1.00', '1.00');
INSERT INTO `gr_infos` VALUES ('gr_5_3', 'GR5.3', '', '选择相应的技术工具，针对软件工程及相关领域的复杂工程问题，进行预测和模拟', '0.00', '0.00', '0.00', '1.00', '1.00');
INSERT INTO `gr_infos` VALUES ('gr_6_1', 'GR6.1', '', '掌握至少一个应用领域中软件工程技术的应用方法和应用实践', '0.00', '0.00', '0.00', '1.00', '1.00');
INSERT INTO `gr_infos` VALUES ('gr_6_2', 'GR6.2', '', '能够识别复杂软件工程的解决方案对社会、健康、安全、法律以及文化的影响', '0.00', '0.00', '0.00', '1.00', '1.00');
INSERT INTO `gr_infos` VALUES ('gr_6_3', 'GR6.3', '', '能够评价复杂软件工程的解决方案对社会、健康、安全、法律以及文化的影响，并理解应承担的责任', '0.00', '0.00', '0.00', '1.00', '1.00');
INSERT INTO `gr_infos` VALUES ('gr_7_1', 'GR7.1', '', '能够理解软件工程实践对环境和社会可持续发展的影响', '0.00', '0.00', '0.00', '1.00', '1.00');
INSERT INTO `gr_infos` VALUES ('gr_7_2', 'GR7.2', '', '能够评价软件工程实践对环境和社会可持续发展的影响', '0.00', '0.00', '0.00', '1.00', '1.00');
INSERT INTO `gr_infos` VALUES ('gr_8_1', 'GR8.1', '', '尊重生命、关爱他人、诚信守则，具有人文知识、思辨能力、处事能力和科学精神', '0.00', '0.00', '0.00', '1.00', '1.00');
INSERT INTO `gr_infos` VALUES ('gr_8_2', 'GR8.2', '', '理解社会主义核心价值观，具有推动民族复兴和社会进步的责任感', '0.00', '0.00', '0.00', '1.00', '1.00');
INSERT INTO `gr_infos` VALUES ('gr_8_3', 'GR8.3', '', '具有软件工程系统的质量、环境、职业健康、安全和服务意识，理解并遵守职业道德和规范', '0.00', '0.00', '0.00', '1.00', '1.00');
